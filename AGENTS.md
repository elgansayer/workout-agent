...
## 7. Known Issues / Audit Findings (Last audited 2026-08-07, hourly dead-code sweep #642 checked 2026-08-07, hourly test watch #653 checked 2026-08-07)
...
- **Hourly dead-code sweep #642 re-verified (2026-08-07).** `dead_code_sweep.py` executed
  ...
  `webapp/app.py` — `_run_hevy_inference()` helper, `/api/hevy/infer` route). No
  truly dead code found. Stale pycache cleaned: 0.
