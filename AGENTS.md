...
## 7. Known Issues / Audit Findings (Last audited 2026-08-07, hourly dead-code sweep #605 checked 2026-08-07, hourly test watch #592 checked 2026-08-07)
...
- **Test coverage audit** (last updated 2026-08-07, re-verified
  ...
  full test suite stands at 565 passing tests covering 31 test modules.
...
- **Hourly dead-code sweep #605 re-verified.** `dead_code_sweep.py` executed
  ...
  `webapp/app.py`). `sync_history.py` confirmed wired (`main.py` and `webapp/app.py`).
